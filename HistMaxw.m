function HistA=HistMaxw(FileName,TrekName,TimeInt,CalAmp,AmpC,AmpM,Te,Ne,Time,AvTime);
...
MinTime = Time-AvTime/2;
MaxTime = Time+AvTime/2;
TimeSpectralIntervalNum=1;
TimeSpectralInterval=AvTime;
