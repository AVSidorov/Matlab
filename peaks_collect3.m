function peaks1=peaks_collect3(TrekSet,AmpHV,AmpPVQ);
Ampdef=94.3333;
Ns=TrekSet.name(1:2);
N=str2num(Ns);
...
peaks1(:,6)=peaksSh/5.9/Amp;
peaks1(:,7)=peaks(:,3);
peaksSh=circshift(peaks(:,2),2);
peaksSh(1:2)=0;
peaks1(:,8)=peaks(:,2)-peaksSh;
peaks1(1:2,8)=0;
peaksSh=circshift(peaks(:,2),3);
peaksSh(1:3)=0;
peaks1(:,9)=peaks(:,2)-peaksSh;
peaks1(1:3,9)=0;
