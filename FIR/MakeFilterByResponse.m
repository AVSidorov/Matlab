...
% arguments. Refactore MakeKernelBy Response will utilize this function
...
FilterSet.Kernel=Kernel;
FilterSet.Yfilter=Yfilter;
FilterSet.Ypulse=Ypulse;
FilterSet.Yresp=Yresp;
FilterSet.NFFT=NFFT;
FilterSet.Fs=Fs;
FilterSet.f=f;
