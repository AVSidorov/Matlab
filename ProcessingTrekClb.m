function [peaks,trekMinus,StandardPulseFirst]=ProcessingTrekClb(FileName);
...
if isstr(FileName)
    ...
    assignin('base',['StP17T',num2str(round(ProcIntTime(1)/1000)),'d',num2str(round(ProcIntTime(end)/1000)),'ms'],StandardPulseFirst);
end;
...
if isstr(FileName)
    ...
    assignin('base',['p17T',num2str(round(ProcIntTime(1)/1000)),'d',num2str(round(ProcIntTime(end)/1000)),'ms'],peaks);
end;    
